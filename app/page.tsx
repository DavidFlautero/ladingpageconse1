...
async function getVehicleSectionsForLanding(): Promise<Section[]> {
  if (!supabaseAdmin) {
    console.error("[app/page] Supabase envs faltantes (supabaseAdmin null).");
    return [];
  }
              ...
              <div className="max-w-3xl space-y-5">
                ...
                <div className="flex flex-wrap items-center gap-3 pt-1">
                  ...
                  <p className="text-[11px] text-slate-200 max-w-xs">
                    Cupos limitados. Consulta sin costo. No impacta tu scoring.
                    Te contactan solo por las alternativas que aplican a tu
                    perfil.
                  </p>
                </div>
              </div>
      ...
      <footer className="border-t border-slate-200 bg-[#f3f1eb]">
        <div className="max-w-5xl mx-auto px-6 md:px-10 lg:px-20 py-8 md:py-10 text-[11px] md:text-xs text-slate-600 space-y-4">
          <div className="space-y-2">
            ...
            <p className="font-semibold">Última actualización: 07/01/2026.</p>
          </div>
